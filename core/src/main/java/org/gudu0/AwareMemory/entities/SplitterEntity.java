...
public final class SplitterEntity extends TileEntity {
    ...
    private Branch firstChoice() {
        ...
        switch (variant) {
            ...
            case FR: {
                branchToReturn = (toggle ? Branch.RIGHT : Branch.FORWARD);
                break;
            }
            case LR: {
    ...
    private Branch secondChoice() {
        ...
        switch (variant) {
            ...
            case FR: {
                branchToReturn = (toggle ? Branch.FORWARD : Branch.RIGHT);
                break;
            }
            case LR: {
    ...
    private int[] branchNearDecisionBase(Branch b) {
        ...
        int[] returnedCell = new int[]{3, 2}; //Default to Forward
        switch (b) {
            case FORWARD: {
                returnedCell = new int[]{3, 2};
                break;
            }
            case LEFT: {
                returnedCell = new int[]{2, 3};
                break;
            }
            case RIGHT: {
    ...
    private int[] exitCellBase(Branch b) {
        ...
        int[] returnedCell2 = new int[]{3, 2};
        switch (b) {
            case FORWARD: {
                returnedCell2 = new int[]{4, 2}; // east edge center
                break;
            }
            case LEFT: {
                returnedCell2 = new int[]{2, 4};    // north edge center
                break;
            }
            case RIGHT: {
